...
{
    public partial class FrmSueldoAsignaciones : Form
    {
        ...
        private void InitializeDataGridView()
        {
            ...
            DgvAsignaciones.Columns[3].DefaultCellStyle.Format = "C";
        ...
        {
            FrmSueldoAsignacionesABM frmAgregar = new FrmSueldoAsignacionesABM(FrmSueldoAsignacionesABM.FormMode.nuevo);
        ...
        private void BtnEditar_Click(object sender, EventArgs e)
        {
            ...
            FrmSueldoAsignacionesABM frmEditar = new FrmSueldoAsignacionesABM(FrmSueldoAsignacionesABM.FormMode.actualizar, sueldoAsignacion);
